...
export const introData = {
  ...
  description3: [
    ...
    <br />,
    "Not long after, I took a course on Introduction to Web Development by Code First Girls and currently taking Google UX Design Professional Certificate.",
    <br />,
